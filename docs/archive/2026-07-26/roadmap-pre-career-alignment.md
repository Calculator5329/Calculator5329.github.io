# Archived Portfolio Site Roadmap

Archived 2026-07-26 during documentation reconciliation. This is the complete
superseded roadmap from before the site queue was aligned with the parent
`career` roadmap. Use [`../../roadmap.md`](../../roadmap.md) for current work.
